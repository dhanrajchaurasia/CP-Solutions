...
void solve()
{
    ...
    cin >> v;
    sort(all(v));
    string a = to_string(v[n - 1]) + to_string(v[n - 2]) + to_string(v[n - 3]);
    string b = to_string(v[n - 1]) + to_string(v[n - 3]) + to_string(v[n - 2]);
    string c = to_string(v[n - 3]) + to_string(v[n - 2]) + to_string(v[n - 1]);
    string d = to_string(v[n - 3]) + to_string(v[n - 1]) + to_string(v[n - 2]);
    string e = to_string(v[n - 2]) + to_string(v[n - 1]) + to_string(v[n - 3]);
    string f = to_string(v[n - 2]) + to_string(v[n - 3]) + to_string(v[n - 1]);
