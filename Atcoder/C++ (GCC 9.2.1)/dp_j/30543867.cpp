...
double recur(int x, int y, int z)

{
    ...
    ans = n + x * recur(x - 1, y, z) + y * recur(x + 1, y - 1, z) + z * recur(x, y + 1, z - 1);
...

{
    ...
    // dp[i][j][k] = no of moves for i(no of 1 sushi), j(..2.), k(..3.)
    ...
    cout << recur(freq[0], freq[1], freq[2]) << endl;
